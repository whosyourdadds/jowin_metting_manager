(function ($) {
    ...
    $.fn.tautocomplete = function (options, callback) {
        ...
        var tautocomplete = {
            ...
            capital:function(){
            	return el.ddTextbox.data("capital");
            },
            searchdata: function () {
        ...
        // assign data fields to the textbox, helpful in case of .net postbacks
        {
            ...
            el.ddTextbox.attr("data-capital",capital)
            el.ddTextbox.attr("placeholder","请添加参会人");
            el.ddTextbox.attr("id","attendeeModile");
...
//          console.log(((e.keyCode < 96 || e.keyCode > 105) && (e.keyCode < 46 || e.keyCode > 57)) && (e.keyCode != 8));
//keyCode是键盘键码通过keyCode判断输入的字符是否符合自动完成，96-105是小键盘数字，46-57是键盘顶部数字。
//安卓的keyCode显示都是229.所以这里也只能将229放过，不过这样特殊字符和字母都能够判断进入了。
            if (((e.keyCode < 96 || e.keyCode > 105) && (e.keyCode < 46 || e.keyCode > 57)) && (e.keyCode != 8 && e.keyCode != 229)) {
                e.preventDefault(); 
                return;
            }
        ...
        function select() {
            ...
            el.ddTextbox.data("capital", selected.find('td').eq(3).text());
